...
class Worker:
    ...
    def update_level(self, level_string):
...
class ESTrainer(Trainer):
    ...
    @override(Trainer)
    def get_weights(self, policies = None) -> dict:
        return {'default_policy': self.policy.model.state_dict()}

    @override(Trainer)
    def set_weights(self, weights):
        self.policy.model.load_state_dict(weights['default_policy'])
